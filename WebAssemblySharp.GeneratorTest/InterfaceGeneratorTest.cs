...
{
    [TestMethod]
    public async Task GenerateInterfaceForTuples()
    {
        var inputSource = @"
            using WebAssemblySharp.Attributes;
            using WebAssemblySharpExampleData;
            ...
            [WebAssemblyModuleDefinition(""local"")]
...
public partial interface ITest
{
   public ValueTask<int> return_default();
   public ValueTask<ValueTuple<int,int,int>> unnamed_locals(int p_Value_0, int p_Value_1);
   public ValueTask<ValueTuple<int,int,int>> named_by_index(int p_Value_0, int p_Value_1);
   public ValueTask<ValueTuple<int,int,int,int>> some_unnamed(int p_Value_0, int p_Value_1);
   public ValueTask<ValueTuple<int,int,int,int>> multi_decl(int p_Value_0, int p_Value_1);
}
";

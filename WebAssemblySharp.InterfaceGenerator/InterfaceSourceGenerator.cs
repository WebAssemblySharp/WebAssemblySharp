...
public class InterfaceSourceGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext p_Context)
    {
        ...
        Debug("Initializing InterfaceSourceGenerator...");
    ...
    {
        Debug("Generating interface source for " + p_InterfaceClass.Name + " in namespace " + p_InterfaceClass.Namespace);
...
#pragma warning disable CS0162 // Unreachable code detected
        lock (m_DebugLock)
        {
            ...
            StreamWriter l_DebugStreamWriter = new StreamWriter(l_FileStream, Encoding.UTF8);
            l_DebugStreamWriter.WriteLine("[" + Process.GetCurrentProcess().Id +"] " + p_Message);
            l_DebugStreamWriter.Flush();
            l_FileStream.Flush();
            l_DebugStreamWriter.Close();
            l_FileStream.Close();
